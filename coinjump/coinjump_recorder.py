...
from coinjump.helpers import create_coinjump_instance
from imageviewer import ImageViewer

from coinjump.paramLevelGenerator import ParameterizedLevelGenerator
...
def run():
    ...
    coin_jump = create_coinjump_instance(start_on_first_action=True)
...
def save_recording(coinjump, actions, save_dir):
