...
from src.coinjump.coinjump_learn.training.data_transform import extract_state, sample_to_model_input_dodge
...
class CoinJumpEnvDodge(gym.Env):
    ...
    def create_new_coinjump(self):
        self.coinjump = create_coinjump_instance(dodge=True,
...
gym.envs.register(
     ...
     entry_point='src.coinjump_learn.env.coinJumpEnvDodge:CoinJumpEnvDodge',
