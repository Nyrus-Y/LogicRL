...
from src.environments.coinjump.coinjump_learn.training.data_transform import extract_state, sample_to_model_input_V1


class CoinJumpEnvNeural(gym.Env):
...
gym.envs.register(
    ...
    entry_point='src.enviroments.coinjump.coinjump_learn.env.CoinJumpEnvNeural:CoinJumpEnvNeural',
