...
from src.nsfr_utils import denormalize_kandinsky, get_data_loader, get_data_pos_loader, get_prob, get_nsfr_model, update_initial_clauses
from src.nsfr_utils import save_images_with_captions, to_plot_images_kandinsky, generate_captions
...
def main(n):
    ...
    # Create RTPT object
    rtpt = RTPT(name_initials='QD', experiment_name=name, max_iterations=args.epochs)
