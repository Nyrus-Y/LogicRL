...
def create_coinjump_instance(seed=None, key_door=False, dodge=False, V1=False, print_seed=False, generator_args=None,
                             **kwargs):
    ...
    if key_door:
        ...
        coin_jump = CoinJump(Dodge_model=True, **kwargs)
