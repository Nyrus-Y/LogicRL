...
from coinjump.coinjump.actions import unify_coin_jump_actions

#fix some imports for unpickling
import coinjump.coinjump.actions as cjActions
import coinjump.coinjump.entityEncoding as cjEntityEncoding
