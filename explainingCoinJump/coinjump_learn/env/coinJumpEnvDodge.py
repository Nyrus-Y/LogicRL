...
from coinjump.coinjump.actions import CJA_NUM_EXPLICIT_ACTIONS, coin_jump_actions_from_unified
from coinjump.coinjump.helpers import create_coinjump_instance
from coinjump_learn.training.data_transform import extract_state, sample_to_model_input_dodge


class CoinJumpEnvDodge(gym.Env):
    ...
    def observe_state(self):
        ...
        ob = sample_to_model_input_dodge((extract_state(self.coinjump), None), no_dict=True)
...
gym.envs.register(
     ...
     entry_point='coinjump_learn.env.coinJumpEnvDodge:CoinJumpEnvDodge',
